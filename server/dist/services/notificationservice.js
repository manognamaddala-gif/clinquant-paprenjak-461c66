...
export async function notifyTrustedContact(payload) {
    if (!env.TRUSTED_CONTACT_WEBHOOK_URL)
        return { sent: false, reason: "Trusted-contact notification provider is not configured" };
    try {
