...
// ============================================================
export async function placeSearch(text, lat, lng) {
...
// NEARBY SEARCH
// ============================================================
export async function nearbySearch(text, lat, lng) {
    return placeSearch(`${text} near ${lat},${lng}`, lat, lng);
}
// ============================================================
// REAL ROAD ROUTING - OSRM
// ============================================================
export async function computeRoutes(origin, destination) {
    ...
    const routes = data.routes.map((route) => ({
        ...
        safetyScore: 100,
        safetyLabel: "Tourism Guardian calculated safety score",
        steps: route.legs
...
// ============================================================
export async function nearestRoads(lat, lng) {
    return {
        snappedPoints: [
            {
                location: {
...
// ============================================================
export async function hotelSearch(lat, lng) {
